...
<div class="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div class="w-full flex-col justify-center items-start gap-8 flex">
                        <div class="flex-col justify-start lg:items-start items-center gap-4 flex">
                            ...
                            <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                ...
                                <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400 lg:text-start text-center">
    ...
    <section class="bg-white dark:bg-white-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                <h2 class="text-indigo-700 text-4xl font-bold font-manrope leading-normal text-center">Our Team</h2>
                <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the whole collection of open-source web components and elements built with the utility classes from Tailwind</p>
            </div>
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                @foreach($members as $row)
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-white-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg pl-4" src="{{ asset($row->image) }}" style="height:100px;" alt="">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-gray">
                            <a href="#">{{ $row->name }} </a>
                        </h3>
                        <span class="text-gray-500 dark:text-gray-400">{{ $row->profession }}</span>
                        ...
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray">
    ...
    <section class="bg-white dark:bg-white-900">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-gray-900 md:text-4xl">You'll be in good company</h2>
            <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-4 dark:text-gray-400">
                ...
                <a href="#" class="flex gap-4 justify-center items-center">
                    <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg pl-4" src="{{ asset($row->customers_logo) }}" style="height:60px; width:80px;" alt="">
                    <p class="w-100 text-xl text-dark hover:text-gray-900 dark:hover:text-gray-900" viewBox="0 0 125 35" fill="currentColor">
                        {{ $row->customers_name }}
                    </p>
                </a>
                @endforeach
