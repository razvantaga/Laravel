                ...
                <div class="shop_content">
                    <div class="shop_bar clearfix">
                        ...
                        <div class="shop_sorting">
                            <ul>
                                <li>
                                    <span class="sorting_text">Order<i class="fas fa-chevron-down"></span></i>
                                    <ul>
                                        <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "asc" }'>ASCENDENT</li>
                                        <li class="shop_sorting_button" data-isotope-option='{ "sortBy": "desc" }'>DESCENDENT</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
